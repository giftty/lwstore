...
void initState() {
super.initState();
tbc = TabController(length: 3, vsync: this);
scroll.addListener(() {
//  print(scroll.offset);
if (scroll.offset > 5) {
chkstreach = true;
...
child: Text("Apps",style: TextStyle(color:Colors.grey[800]),),
),
Container(
width: 120.0, height: 30.0,
decoration: BoxDecoration(
...
alignment: Alignment.center,
child: Text("Games",style: TextStyle(color:Colors.grey[800])),
),
Container(
width: 120.0, height: 30.0,
decoration: BoxDecoration(
...
alignment: Alignment.center,
child: Text("Profile",style: TextStyle(color:Colors.grey[800])),
),
